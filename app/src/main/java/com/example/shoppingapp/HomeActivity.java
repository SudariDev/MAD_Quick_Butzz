    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        upload_prescription.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(HomeActivity.this, Order_Delivery.class);
                    ...
                    protected void onBindViewHolder(@NonNull ProductViewHolder holder, int i, @NonNull final Products model) {
                        ...
                        holder.itemView.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                if(type.equals("Admin"))
                                {
                                    Intent intent = new Intent(HomeActivity.this, com.example.shoppingapp.editItems.class);
                                    intent.putExtra("pid",model.getPid());
                                    startActivity(intent);
                                }
                                else
                                {
                                    Intent intent = new Intent(HomeActivity.this, com.example.shoppingapp.Display_Item.class);
                                    intent.putExtra("pid",model.getPid());
                                    startActivity(intent);
                                }
