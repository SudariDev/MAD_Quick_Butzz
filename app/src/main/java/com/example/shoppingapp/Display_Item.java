...
public class Display_Item extends AppCompatActivity {
    ...
    private void addingToCartList() {
        ...
        cartListRef.child("User View").child(Prevalent.currentonlineUser.getPhoneNo()).child("products").child(productID).updateChildren(cartMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
    ...
    private void CheckOrderState(){
        ...
        ordersRef = FirebaseDatabase.getInstance().getReference().child("Orders").child(Prevalent.currentonlineUser.getPhoneNo());
